...
export class OrdersService {
  ...
  /**
   * Listar órdenes paginadas con filtros opcionales.
   */
  async findAll(query: QueryOrdersDto): Promise<PaginatedResult<any>> {
  ...
  async addItem(orderId: string, dto: AddOrderItemDto) {
    ...
    // V = PVP Venezuela (Manual o Sugerido)
    const V_pvpVzlaManual = dto.pvp_venezuela ? Number(dto.pvp_venezuela) : U_costoAjustadoVzla;
